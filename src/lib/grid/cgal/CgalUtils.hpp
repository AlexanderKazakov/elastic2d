#ifndef LIBGCM_CGALUTILS_HPP
#define LIBGCM_CGALUTILS_HPP
...
namespace gcm {
	class CgalUtils {
		...
		void mesh2DTriangle() {
			...
			std::cout << cdt.number_of_faces() << std::endl;
			std::cout << "Meshing the triangulation..." << std::endl;
			CGAL::refine_Delaunay_mesh_2(cdt, Criteria(0.125, 3));
			std::cout << "Number of vertices: " << cdt.number_of_vertices() << std::endl;
			std::cout << cdt.number_of_faces() << std::endl;
		}
	};
