...
namespace gcm {
	namespace linal {
		...
		template<int TM>
		Matrix<TM, TM, DiagonalMatrixContainer<TM>> Matrix<TM, TM, DiagonalMatrixContainer<TM>>::transpose() const {
			return (*this);
		}

		template<int TM>
		void Matrix<TM, TM, DiagonalMatrixContainer<TM>>::transposeInplace() { }

		template<int TM>
		Matrix<TM, TM, DiagonalMatrixContainer<TM>> Matrix<TM, TM, DiagonalMatrixContainer<TM>>::invert() const {
		...
		template<int TM>
		void Matrix<TM, TM, DiagonalMatrixContainer<TM>>::invertInplace() {
			(*this) = invert();
		}
