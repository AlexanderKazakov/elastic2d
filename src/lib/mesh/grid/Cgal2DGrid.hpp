...
public:
	...
	/**
	 * Iteration over all real mesh faces (there are also not meshing  ("!is_in_domain()") faces
	 *in the triangulation,
	 * this caused by the fact that CGAL triangulation is a convex hull of its vertices, we
	...
	CellIterator cellBegin() const { return CellIterator(
