...
SimplexGrid(const Task& task, GlobalScene* gS, const GridId gridId_) :
		UnstructuredGrid(task, Grids::T::CUBIC, DIMENSIONALITY, gridId_),
		triangulation(&(gS->triangulation)) {
